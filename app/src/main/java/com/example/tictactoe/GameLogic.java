...
public class GameLogic {
    ...
    public boolean winnerCheck() {
        ...
        if (isWinner) {
            if (playAgainBTN != null && homeBTN != null && playerTurn != null) {
            ...
            // Check if there's a winning line displayed, if yes, hide it
            if (winType[0] != -1 && winType[1] != -1 && winType[2] != -1) {
